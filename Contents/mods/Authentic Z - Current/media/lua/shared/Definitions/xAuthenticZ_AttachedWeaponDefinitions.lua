...
AttachedWeaponDefinitions.handgunJohnMorgan = {
	chance = 100,
	outfit = {"AuthenticDIJohnMorgan", "AuthenticNMRIHWally","AuthenticNMRIHBadass", "AuthenticB4BHoffman"},
	weaponLocation = {"Holster Left", "Holster Right"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
...
AttachedWeaponDefinitions.SpikesWinslowLArm = {
	...
	weaponLocation =  {"Spike L-Arm 1", "Spike L-Arm 2", "Spike L-Arm 3", "Spike L-Arm 4","Spike L-Arm 5","Spike L-Arm 6","Spike L-Arm 8"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
	weapons = {
...
AttachedWeaponDefinitions.SpikesWinslowRArm = {
	...
	chance = 100,
	outfit = {"AuthenticWinslow"},
	weaponLocation =  {"Spike R-Arm 1", "Spike R-Arm 2", "Spike R-Arm 3", "Spike R-Arm 4","Spike R-Arm 5","Spike R-Arm 6","Spike R-Arm 7"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
	weapons = {
