...
-- more melee in back!
AttachedWeaponDefinitions.BaseballBat = {
	chance = 100,
...
AttachedWeaponDefinitions.AuthenticZoey = {
	chance = 100,
	outfit = {"AuthenticZoey", "AuthenticBillOverbeck", "AuthenticCoach", "AuthenticEllis", "AuthenticNick", "AuthenticRochelle"},
	weaponLocation = {"Holster Left", "Holster Right"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
...
AttachedWeaponDefinitions.AuthenticDianneCaldwell = {
	chance = 100,
	outfit = {"AuthenticDianneCaldwell", "AuthenticDayZHeroBleu","AuthenticDRBradGarrison"},
	weaponLocation = {"Holster Left", "Holster Right"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
...
AttachedWeaponDefinitions.ShortSpikesWinslow = {
	...
	chance = 100,
	outfit = {"AuthenticWinslow"},
	weaponLocation =  {"Spike Back 1", "Spike Back 2", "Spike Back 3", "Spike Back 6"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
	weapons = {
...
AttachedWeaponDefinitions.MediumSpikesWinslow = {
	...
	chance = 100,
	outfit = {"AuthenticWinslow"},
	weaponLocation =  {"Spike Back 4", "Spike Back 5"},
	bloodLocations = nil,
	addHoles = false,
	daySurvived = 0,
	weapons = {
...
AttachedWeaponDefinitions.attachedWeaponCustomOutfit.AuthenticWaiter_Coffee = {
	chance = 100;
	weapons = {
		AttachedWeaponDefinitions.CoffeeCup,
	},
